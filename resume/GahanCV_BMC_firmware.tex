...
\textbf{Description}: AI-powered \textbf{JIRA dashboard} for defect analysis and real-time triage prediction for enterprise validation workflows using LangGraph and embeddings.
