...
\address{\\ gahansaraiya@gmail.com \\  \faLinkedin \ \href{https://www.linkedin.com/in/gahan-saraiya/}{linkedin.com/in/gahan-saraiya}}  % Your phone number and email
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    filecolor=magenta,      
...
\begin{itemize}
    ...
    \item Generative AI adaptation for Firmware Development Productivity.
\end{itemize}
...
Cloud Technologies & GCP, AWS, Digital Ocean, JFrog Artifactory, TeamCity, JIRA
