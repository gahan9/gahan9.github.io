...
\textbf{Description}: Modernized software engineering, repository management, and code review processes using Agentic AI and GenAI (Claude, Cursor). Developed multi-tool compatible skills, agents, and hooks with strict security compliance, enforcement, and token spend restrictions.

{\textbf{\textcolor{accentColor}{Context-Aware Task Routing \& Resolution with LangGraph}}} \hfill {2025 - Present}\\
\textbf{Description}: Led a team and managed sprints to achieve context-aware task/issue disposal using LangGraph. Implemented smart routing via LLMs and semantic FAISS, integrating OpenAI, Vertex AI, and local LLMs. Built data source connectors for GitHub, Jira, and historical data, alongside a persona-based counselor model to summarize findings, adapt advisory content, and generate actionable items post-quality matrix checks.
